...
- [ ] `pip install -r requirements.txt` 정상 설치
- [O] Python 3.10+ 호환 확인
...
### 완료 조건
- [ ] 파이프라인 실행 중 주기적 저장
- [ ] 재실행 시 checkpoint 감지 및 복구 옵션 제공
- [ ] 정상 완료 시 자동 삭제
...
### 완료 조건
- [ ] 프롬프트 전송 및 task_id 수신
- [ ] 잘못된 프롬프트 시 명확한 에러 반환
- [ ] instrumental 옵션 동작
